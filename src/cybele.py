...
def find_word_in_dicts(word, core):
	...
	if list_name == "greatings":
		...
		print(f"{kolor['VIVID_GREEN']}{_spchar_[16:17]} linux command detected. Executing, disallowed parameters:{kolor['OFF']}\n")
		execute_linux_command(word.lower())
...
def list_country_details():
	...
	for country_name, details in ncountries.items():
		display_country_name = country_name.title()
